...
class Gallery_model extends Model {
  ...
  public function albums() { // fonction qui interoge la base de donné et retourné un tableau d'albums
    try {
      $statement = $this->db->prepare("select * from albums"); // préparé la requete en Sql avec 
      //en utilisant la fonction prepare de PDO
      $statement->execute(); // execute la requete
      return $statement->fetchAll(); // fetch la requete
