<div class="row">
  <?php foreach ($photos as $photo) { ?>
    <div class="col-sm-3 col-md-3">
      <div class="thumbnail">
        <a class="close" href="/index.php/gallery/photos_delete/<?=$album_id?>/<?=$photo['photo_id']?>">×</a>
        <br> <br> 
        <a style="height: 200px; width: 400px; display: table-cell; vertical-align: middle; text-align: center;"
           href="/index.php/gallery/photos_show/<?=$album_id?>/<?=$photo['photo_id']?>">
...
<a href="/index.php/gallery/photos_new/<?=$album_id?>"  class="btn btn-primary" role="button">Ajouter une photo</a>
